...
enum FxAgentProvider: String, CaseIterable, Codable, Identifiable, Sendable {
    case gateway
    case cliProxyAPI
    case codex
    case grok
    ...
    var requiresLocalGateway: Bool {
        self == .gateway || self == .cliProxyAPI
    }

    var fxProviderValue: String {
        self == .cliProxyAPI ? FxAgentProvider.gateway.rawValue : rawValue
    }
}
...
struct ChatSession: Identifiable, Equatable, Codable {
    ...
    var kind: ChatSessionKind? = nil
    var workingDirectory: String? = nil
    var fxSessionID: String? = nil
